              ...
              builder: (context, ref, child) {
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(
                          Icons.cloud_off,
                          size: 64,
                          color: LinearColors.textTertiary.withValues(
                            alpha: 0.3,
                          ),
                        ),
                        ...
                        Text(
                          ...
                          style: Theme.of(context).textTheme.titleMedium
                              ?.copyWith(color: LinearColors.textTertiary),
                        ),
                ...
                return ListView.builder(
                  padding: const EdgeInsets.symmetric(
                    horizontal: LinearSpacing.spacing16,
                  ),
...
class _ConnectionManagementItem extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<_ConnectionManagementItem> createState() =>
      _ConnectionManagementItemState();
}

class _ConnectionManagementItemState
    extends ConsumerState<_ConnectionManagementItem> {
