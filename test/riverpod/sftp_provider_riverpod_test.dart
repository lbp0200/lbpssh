  ...
  group('SftpNotifier', () {
    ...
    group('openTab', () {
      test(
        ...
        when(() => mockTerminalService.getSession(connection.id))
            .thenReturn(mockSession);

        // Act (When)
        final tab = await container.read(sftpProvider.notifier).openTab(connection);
      ...
      test(
        ...
        when(() => mockTerminalService.getSession('nonexistent'))
            .thenReturn(null);
    ...
    group('getTab', () {
      test(
        ...
        when(() => mockTerminalService.getSession(connection.id))
            .thenReturn(mockSession);
        final createdTab = await container.read(sftpProvider.notifier).openTab(connection);

        // Act (When)
        final result = container.read(sftpProvider.notifier).getTab(createdTab.id);
      ...
      test(
          ...
          () {
        // Act (When)
        final result = container.read(sftpProvider.notifier).getTab('nonexistent');
