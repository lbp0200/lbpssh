...
void main() {
  group('TerminalConfig', () {
    ...
    test(
      'Given valid JSON, When deserializing, Then creates TerminalConfig correctly',
      () {
        final json = {
          'fontFamily': 'Consolas',
          'fontSize': 18.0,
    ...
    test(
      'Given TerminalConfig, When accessing defaultConfig, Then returns default config',
      () {
